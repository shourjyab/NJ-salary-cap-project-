...
//Number of unique values of DistrictNumber is 588
...
replace supe=1 if EMP_JOB_TITLE_2 =="SUPERINTENDENT"
replace supe=1 if EMP_JOB_TITLE_2 =="Superintendent/SBA"
...
//fixing total>1
//1. dist 1860 - one ex asst one super
replace supe=0 if DistrictNumber==1860 & EMP_JOB_TITLE_2 =="Superintendent"
//2. dist 4860 same as above  
replace supe=0 if DistrictNumber==4860 & EMP_JOB_TITLE_2 =="Superintendent"
//3. dist 5670 same as above
replace supe=0 if DistrictNumber==5670 & JobTitle=="Executive Assistant" 
...
use 16_salary_r
keep if supe==1
rename JobTitle JobTitle16
rename EmployeeName EmployeeName16
rename EMP_BASE_SAL BaseSalary16
rename EMP_BEGIN_DATE BeginDate16
rename EMP_END_DATE EndDate16
rename EMP_FTE FTE16
rename EMP_SHARED Yes16
keep DistrictNumber DistrictName JobTitle16 EmployeeName16 BaseSalary16 BeginDate16 EndDate16 FTE16 Yes16
